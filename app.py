...
st.markdown("<h1 style='text-align: center; color: #2a2b2a;'>COVID-19 Prediction App</h1>", unsafe_allow_html=True)
...
st.button(
    'Open link',
    on_click=open_page,
    args=('https://predictcovid.streamlit.app/',),
    css='background-color: red; color: white; border-radius: 5px;'
)
